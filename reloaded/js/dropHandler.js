...
export class DropZoneHandler {
  constructor(viewer) {
    ...
    // this.dropZone = document.getElementById("body");
    this.overlay = document.getElementById("dropZoneOverlay");
  ...
  handleDragEnter(e) {
    ...
    // this.dropText.textContent = "Drop your files here";
  }
  ...
  handleDragLeave(e) {
    ...
    e.stopPropagation();
    if (e.x == 0 && e.y == 0) {
      this.overlay.style.display = 'none'; //hide when cursor leaves window
    }
