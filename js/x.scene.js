function loadScene(sceneUrl) {
  ...
  $.ajax({
    ...
    if (typeof scene.volume != 'undefined' && typeof scene.volume.file != 'undefined') {
      if (scene.volume.file.length > 0) {
        ...
        if (typeof scene.labelmap != 'undefined' && typeof scene.labelmap.file != 'undefined') {
          if (scene.labelmap.file.length > 0) {

            volume.labelmap.file = scene.labelmap.file[0];
            _data.labelmap.file = volume.labelmap.file;

            if (typeof scene.colortable != 'undefined' && typeof scene.colortable.file != 'undefined') {
    ...
    if (typeof scene.mesh != 'undefined' && typeof scene.mesh.file != 'undefined') {
      if (scene.mesh.file.length > 0) {
        ...
        if (typeof scene.scalars != 'undefined' && typeof scene.scalars.file != 'undefined') {
    ...
    if (typeof scene.fibers != 'undefined' && typeof scene.fibers.file != 'undefined') {
