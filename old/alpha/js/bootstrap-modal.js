...
!function($) {
  ...
  var Modal = function(content, options) {
    ...
    this.$element = $(content).delegate('[data-dismiss="modal"]',
  ...
  function backdrop(callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      $.support.transition && this.$element.hasClass('fade') ? this.$backdrop
          .one($.support.transition.end, $.proxy(removeBackdrop, this))
  ...
  $.fn.modal = function(option) {
    ...
    return this.each(function() {
      ...
      var $this = $(this), data = $this.data('modal'), options = $.extend({},
          $.fn.modal.defaults, $this.data(), typeof option == 'object' &&
              option)
      if (!data) {
